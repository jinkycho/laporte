		...
		<section>
			...
			<div class="container">
					...
					<c:choose>
						<c:when test="${output == null || fn:length(output) == 0}">
							...
							<div class="order_none">
								...
								<div class="order_blank">
									<p>찾는 주문 내역이 없으신가요?
										<a href="#" class="orderfna_link">고객지원센터</a> 로 문의해 주세요.
									</p>
								</div>
							</div>
						</c:when>
						<c:otherwise>
							<c:forEach var="item" items="${output }" varStatus="status">
								<c:if test="${deliveyOutput[status.index].deliverystatus==null || deliveyOutput[status.index].deliverystatus!='C'}" >
									<!-- 주문 목록 -->
				...
				<div id="order_tab_page02">
					<c:choose>
						<c:when test="${deliveyOutput[status.index].deliverystatus!='C'}">
							<div>
								<div class="order_tab_pagenone">
