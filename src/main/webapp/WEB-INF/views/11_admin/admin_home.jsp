					...
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">
											<a href="${pageContext.request.contextPath}/11_admin/admin_visitors.do">주간 방문자 수</a>
										</h4>
									</div>
									<!-- /.card-header 끝 -->
									<!-- card-body  -->
							...
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title"><a href="${pageContext.request.contextPath}/11_admin/admin_order.do">매출 현황</a></h4>
									</div>
									<!-- /.card-header 끝 -->
									<!-- card-body  -->
									<div class="card-body">
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">
											<a href="admin_order.html">주문 현황 <span class="card_subtitle">(최근 1개월 기준)</span></a>
										</h4>
									</div>
									<!-- /.card-header 끝 -->
									<!-- card-body  -->
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">
											<a href="admin_order.html">취소 / 교환 / 반품 / 환불현황 <span class="card_subtitle">(최근 1개월 기준)</span></a>
										</h4>
									</div>
									<!-- /.card-header 끝 -->
									<!-- card-body  -->
		...
		var chart = new Chart(ctx, {
			...
			data : {
				...
				datasets : [ {
					...
					data : [ 2300, 2500, 3000, 2800, 2950, 3300, 3500, 3700 ]
				} ]
			},
		...
		var chart = new Chart(ctx, {
			...
			data : {
				...
				datasets : [ {
					...
					data : [2200, 3000, 1200, 2800, 3800, 3300]
				}, {
					label : 'Last year',
